...
<body style="margin-bottom:80px;background-color: #c9bda7; 
	background-image: url(css/images/sea.jpg);">			
<div class="shell" style="margin-bottom:45px;">
			
<img src="css/images/site.png" width="" height="140" style="margin-bottom:105px;margin-left:-95px;margin-top:30px;">
<H6 style="margin-top:-250px;margin-left:50px;font-size:15px;color:#666666;display: block;">Affliated By Nat. Accreditation Board</h6>
<H6 style="margin-top:-18px;margin-left:600px;font-size:15px;color:#666666;" >Affiliated To  University For Development Studies (UDS)</h6>
<H6 style="margin-top:40px;margin-left:75px;font-size:32px;color:#666666;font-weight:bold" >NEW LIFE COLLEGE </h6>
<br>
...
<img src="css/images/kt.png" width="1000" height="525" alt="Slide Image" />
						
</li>

<li>						
<img src="css/images/vc.jpg"  width="1000" height="525" alt="Slide Image" />
						
</li>
	
<li>
						
<img src="css/images/nl.jpg"  width="1000" height="525" alt="Slide Image" />
						
</li>
					
<li>
						
<img src="css/images/bmk.jpg"  width="1000" height="525" alt="Slide Image" />
						
</li>
					
<li>
		
<img src="css/images/nlc.png" width="1000" height="525" alt="Slide Image" />
						
</li>
	
<li>
		
<img src="css/images/nlc 1.jpg" width="1000" height="525" alt="Slide Image" />
...
<br>				
<img src="css/images/kt2.jpg" alt="Post Image" width="135" height="159"/>
...
echo $row10['info'];
?>
<br><br>  <strong> <h3 style="font-size:22px;text-align:right;color:#87CEFA;margin-top:px;">Mr Christ</p>
					</p>
					<div class="cl">&nbsp;</div>
						</div>
			<!-- End Content -->
...
<h2 style="margin-left:350px;margin-top:;width:500px;font-size:20px;"><center>A message from your  Principal </center></h2>

<br>				
<img src="css/images/kt1.jpg" alt="Post Image" align="right" width="135" style="margin-left:10px;margin-right:10px;" height="159" />
...
$row10=mysql_fetch_array($res10);
echo $row10['info'];
?><br><br>  <strong> <h3 style="font-size:22px;text-align:right;color:#87CEFA;margin-top:-10px;">Mr Gbandi</p>
			</p>
...
border-bottom: 1px  black solid;border-left: 1px  black solid;border-right: 1px  black solid;color:#454545;text-align:left">
                ...
                <div style="padding-left:10px">
                    <div  class="box_us">
                          ...
                          <div  class="box_us_r">
                                <b class="lh">Adjacent the Tpoly boys dometery 

, Tamale Technical Univesity,

digital adrees  post code
NS030
DISTRICT
Sagnerigu
Region
...
9.23268,-08707</b>
			...
			<br>
                    <div  class="box_us">
                          ...
                          <div  class="box_us_r">
                                <b class="lh" >E-mail: Newlifecollegeg@.com</b>
                          </div>
                          <div style="clear: both; height:10px;"></div>
                    </div>
           		</div>
